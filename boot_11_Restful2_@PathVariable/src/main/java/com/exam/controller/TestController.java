...
public class TestController {
	...
	// 요청URL: http://localhost:8090/app/board2/20/kim  ==> num값 20 username값 kim 이용해서 POST(insert) 할 의도임.
	
	@PostMapping("/board2/{num}/{username}")
	public String bbb(@PathVariable("num") String num,
	...
	public String ccc(@PathVariable("num") String num,
	          @PathVariable("username") String username) {
